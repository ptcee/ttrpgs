...
The angler in dock slot 1 chooses a location each round. Each location grants a bonus to the player(s) with the **fewest scales**.
...
Fish are worth **scales** when caught. The winner is the first angler to collect **20 scales**.

| Bracket | Scales | Line Slack |
|---------|----------------|------------|
| Small | 1 scale | 7-9 |
| Average | 2 scales | 5-6 |
| Big | 3 scales | 3-4 |
| Master | 5 scales | 1-2 |
...
The first player to collect **20 scales** wins the Embervast Derby.

> **Scales** represent the recorded weight of your catch as tallied at the weigh-in station at the end of Big Dock. At the close of each day, the dockmaster marks your running total on the leaderboard post. First to 20 scales takes the Charter.
...
## Master (5 scales, Slack 1-2) - 6 cards
...
## Big (3 scales, Slack 3-4) - 10 cards
...
## Average (2 scales, Slack 5-6) - 14 cards
...
## Small (1 scale, Slack 7-9) - 10 cards
...
- **Small fish** have wide slack windows (7-9). They are mostly incidental catches unless a player needs 1 scale to close out the game.
...
| S12 | Downrigger | Yellow | 3 | The player with the most scales must cast their highest tension lure this phase. | Once per round: the player with the most scales must cast their highest tension lure this phase. |
